...
public class ArbolGen {
    ...
    private NodoGen cloneAux(NodoGen nodo) {
        ...
        if (nodo != null) {
            ...
            // creo el nuevo nodo
            if (nodo.getHijoIzquierdo() != null) {
                // si el, nodo izquierdo no es null a el enlace de nuevo le asigno el llamado
                // recursivo
    ...
    private int gradoAux(NodoGen nodo) {
        ...
        if (nodo != null) {
            ...
            if (nodo.getHijoIzquierdo() != null) {
                ...
                while (hijo != null) {
                    // mido el grado de los hijos recursivamente y me quedo con el mas grande
                    // comparandolo con el de esye nivel
